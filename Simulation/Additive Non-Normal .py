...
from scipy.stats import uniform, norm,skewnorm,gamma, beta, f_oneway, wilcoxon,kruskal, ranksums
...
# Simulating the vector of phynotype for each SNP group for additive non-normal Case
